...
public class FoldingCellListAdapter extends ArrayAdapter<Item> {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        if (cell == null) {
            ...
            viewHolder.titleIssueCategory = cell.findViewById(R.id.title_property_issue_category);
            viewHolder.titleIssueDaysPassed = cell.findViewById(R.id.title_property_issue_days_passed);
            viewHolder.titleIssueCurrentStatus = cell.findViewById(R.id.title_property_issue_status);
            viewHolder.titleIssueLocation = cell.findViewById(R.id.title_property_issue_loc);

            viewHolder.orderId = cell.findViewById(R.id.property_issue_id);
            viewHolder.issueReportedDate = cell.findViewById(R.id.property_issue_datatime);
            viewHolder.issueDescription = cell.findViewById(R.id.property_issue_description);
            //viewHolder.issueCategory = cell.findViewById(R.id.property_issue_category);
            viewHolder.issueLocation = cell.findViewById(R.id.property_issue_loc);
    ...
    private void bind(FoldingCell cell, ViewHolder viewHolder, Item item) {
    ...
    private static class ViewHolder {
        // title view
        TextView titleIssueLocation;
        TextView titleIssueCategory;
        TextView titleIssueDaysPassed;
        TextView titleIssueCurrentStatus;
        // content view
        TextView orderId;
        TextView issueLocation;
        TextView issueCategory;
        TextView issueReportedDate;
        TextView issueDescription;
        TextView issueDaysPassed;
        TextView issueCurrentStatus;
    }
}
