...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLoginPref = PreferenceManager.getDefaultSharedPreferences(this);
        mLoginEditor = mLoginPref.edit();
        //.getBoolean("main",false)；当找不到"main"所对应的键值是默认返回false
        if (mLoginPref.getString("token", null) != null) {
            ...
            String id = mLoginPref.getString("id", null);
            if (id != null) {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                mLoginEditor.putString("id", mPhoneNum)
                        .putString("token", mPassword)
                        .commit();
                finish();
                Intent intent = new Intent(LoginActivity.this, MainEntryActivity.class);
                startActivity(intent);
